...
const tagebuchSource = fs.readFileSync(path.join(__dirname, '..', 'tagebuch.jsx'), 'utf8');
...
assert.match(
  tagebuchSource,
  /Ergänzungen zu Eintrag/,
  'entry rendering should show additions clearly grouped below the original entry'
);
